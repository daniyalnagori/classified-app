...
// // ]
var ads = (function () {
    function ads(name, price) {
        this.name = name;
        this.price = price;
    }
    ads.prototype.product = function () {
    };
    return ads;
}());
...
var mobiles = (function (_super) {
    ...
    mobiles.prototype.product = function () {
